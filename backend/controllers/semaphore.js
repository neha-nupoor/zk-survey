...
const wasmFilePath = path.join(__dirname, '..', 'public',  'semaphore.wasm')
const finalZkeyPath = path.join(__dirname, '..', 'public', "semaphore_final.zkey")

console.log(wasmFilePath, finalZkeyPath);
